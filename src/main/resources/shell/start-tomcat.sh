...
file1="${tomcat_home}/com.web-0.0.1-SNAPSHOT.war"
file2="${tomcat_home}/com.backgroud-0.0.1-SNAPSHOT.war"
...
pidlist=`ps -ef |grep tomcat8  |grep -v "grep"|awk '{print $2}'`   
kill -9 $pidlist  
if [ -f "$file1" ]
then
 echo "$file1 doing........"
 ...
 mv $file1 ${tomcat_home}/webapps/project.war
else
